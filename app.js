const menu = [
  ...
  { id: 10, title: "Tiramisu", category: "deserts", price: "$7", description: "Italian dessert made of savoiardi dipped in coffee, layered with a whipped mixture of eggs, sugar, and mascarpone cheese", img: "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8dGlyYW1pc3V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" },
...
function generateMenu(filter = 'all') {
  const menuContainer = document.getElementById('menu-container').querySelector('.row');
  ...
  filteredMenu.forEach(item => {
    menuContainer.innerHTML += 
    `
      <div class="menu-item col-12 col-md-6 col-lg-4 mb-4" data-category="${item.category}">
        <div class="card">
